...
class SimpleController(Node):# creamos la clase del nodo
    def __init__(self): #constructor
        ...
        #Creamos un nuvo nodo para publicar los mensajes con Odometria
        ...
        #Creamos una nuevas varibles que va a servir para implementar el mensaje que queremos guardar para el topic "bumperbot_controller/odom"
    ...
    def jointCallback(self,msg):
        ...
        #Cuando llegan los datos de las ruedas
